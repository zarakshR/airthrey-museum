        ...
        implements ActionListener // For the JButton handling and item selection in the JComboBox
{
    ...
    private JButton createButton = new JButton("Create Treasure");
    ...
    private JTextField newNumberField = new JTextField(10);
    private JTextField newDescriptionField = new JTextField(40);
    private JTextField newRoomField = new JTextField(5);
    private JTextField newImagePathField = new JTextField(15);
    ...
    public void init() {
        ...
        tabbedPane.add("Create New Treasure", createPanel);
        ...
        createPanel.add(newDescriptionField);
        createPanel.add(newNumberField);
        createPanel.add(newRoomField);
        createPanel.add(newImagePathField);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == createButton) {
            int n = Integer.parseInt(newNumberField.getText());
            theData.addEntry(newDescriptionField.getText(), n, newImagePathField.getText(), newRoomField.getText());
            theData.fillChoice(textChoice);
        }
